<div class="product-list-content">
    ...
    <div class="product-list-wapper">
        <h2 class="product-list-title">Danh sách sản phẩm<?php if (!empty($filterSize)) echo ' Size: ' . $filterSize . ' -'; ?><?php if (!empty($filterColor)) echo ' Màu: ' . $filterColor . ' -'; ?><?php echo ' Giá ≤ ' . number_format($filterPrice, 0, ",", ".") . ' VNĐ'; ?></h2>
        <div class="pagination-container">
            ...
            <?php
            require_once "./view/paginationfilter.php"
